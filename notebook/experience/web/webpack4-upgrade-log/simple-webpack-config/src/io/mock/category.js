...
export function getCategory (id) {
  ...
  return delay(`getCategory #${id}`, null, data, false, 500)
}

export function updateCategory (id, params) {
  return delay(`updateCategory #${id}`, params, {}, false, 500)
}

export function addCategory (params) {
  return delay('addCategory', params, {}, false, 500)
}

export function updateCategoryFields (params) {
...
export function updateCategoryProduct (id, params) {
  return delay(`updateCategoryProduct #${id}`, params, {}, false, 500)
}
