...
":hi CursorColumn term=bold,reverse cterm=bold,reverse gui=bold,reverse
":nnoremap <Leader>c :set cursorline! cursorcolumn!<CR>
:set cursorline
:hi CursorLine term=bold,underline cterm=bold,underline gui=bold,underline
